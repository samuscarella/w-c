...
$('#exercise_form_edit').on('ajax:success', function(data, status, xhr) {
            ...
            $('.form-control').val("");
            alert('titty-fucked!!!');
    // $('.exercises-div').append("<%= j render @exercise, :locals => {:exercise => @exercise, :workout => @workout} %>");
    // $('.form-control').val("");
    return false;
});
    // return false;
...
(function() {
  $(document).ready(function() {
    $('#exercise_form_edit').submit(function(e) {
